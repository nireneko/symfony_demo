...
{
    protected static $defaultName = 'neko:user:create';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->userTools->createUser($username, $password);
